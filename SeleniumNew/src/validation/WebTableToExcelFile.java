...
public class WebTableToExcelFile {
    ...
    public static void webtableToExcel(){
        ...
        try{
            ...
            oBrowser.navigate().to("file:///E:/MorningBatch_Combined/HTML/Webtables/SampleWebTables.html");
            Thread.sleep(2000);
            ...
            fout = new FileOutputStream("E:\\MorningBatch_Combined\\autoItScripts\\StudentDetails.xlsx");
            wb.write(fout);
        }catch(Exception e){
            e.printStackTrace();
        }finally{
